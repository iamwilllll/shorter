...
export function LandingFeatureCard({ icon, title, description, ...props }: FeatureCardProps) {
    return (
        <motion.article
            className="border-default-border flex w-full flex-col items-center gap-4 rounded-xl border bg-zinc-950/80 p-4 transition-all duration-300 md:max-w-110 md:flex-row md:items-start md:gap-5 md:p-5"
            {...props}
        >
